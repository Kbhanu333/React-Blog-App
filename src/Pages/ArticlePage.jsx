...
import Social from '../Pages/Images/social.png';
import Reactt from '../Pages/Images/Reactt.png';
import code from '../Pages/Images/code.png';
import rythm from '../Pages/Images/rythm.png';
...
const ArticlePage = () => {
    return (
        ...
        <div className="A2">
            ...
            <img src={Reactt} alt="Reactpng" style={{width:"100%"}} />
